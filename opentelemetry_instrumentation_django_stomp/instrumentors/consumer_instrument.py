...
from opentelemetry_instrumentation_django_stomp.utils.django_stomp_getter import (
    DjangoStompGetter,
)
from opentelemetry_instrumentation_django_stomp.utils.shared_types import CallbackHookT
from opentelemetry_instrumentation_django_stomp.utils.span import (
    enrich_span_with_host_data,
    get_span,
)
from opentelemetry_instrumentation_django_stomp.utils.traced_thread_pool_executor import (
...
class ConsumerInstrument:
    ...
    def instrument(tracer: Tracer, callback_hook: CallbackHookT = None):
        ...
        wrapt.wrap_function_wrapper(
            Listener, "_create_new_worker_executor", wrapper_create_new_worker_executor
        )
